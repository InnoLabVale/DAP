...
import com.innovery.mpm.option.implementations.gui.OptionManagmentInitialization;
import com.innovery.mpm.option.interfaces.gui.OptionManagmentInitializationInterface;
import com.innovery.mpm.provisioning.implementations.BsoResourceInitialization;
...
public class DAP{
	...
	public DAP(Logger log){
		...
		BsoResourceInitializationInterface provisioning = new BsoResourceInitialization(rootComponents);
		OptionManagmentInitializationInterface optionManagment = new OptionManagmentInitialization(rootComponents);
