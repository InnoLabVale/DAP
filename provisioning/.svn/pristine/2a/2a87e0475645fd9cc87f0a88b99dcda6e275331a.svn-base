...
public interface ProvisioningParametersInterface {
	...
	void setCugPanel(JPanel cugPanel);

	void setCugLabel(JLabel cugLabel);

	void setInputRegexList(List<String> inputRegexList);
	...
	void setDiscountLabelList(JLabel discountLabelList);
