...
public class BsoResponseGridManagment implements BsoResponseGridManagmentInterface {
	...
	public void setResponseGridStatusMessage(String message){
		reference.getResponse_fieldset_grid().add(new JLabel(""), components.getCommonGUI().setContraints(GridBagConstraints.VERTICAL, GridBagConstraints.WEST, 5, 20, 0, 0, 0, 0));
		reference.getFrame().repaint();
		reference.getFrame().validate();
		reference.getResponse_fieldset_grid().add(new JLabel(message), components.getCommonGUI().setContraints(GridBagConstraints.VERTICAL, GridBagConstraints.WEST, 5, 20, 0, 0, 0, 0));
		reference.getFrame().repaint();
		reference.getFrame().validate();
	}
	...
	public void setResponseGridAssurance(String response_mpm){
		...
		if(response_mpm.equals(reference.getErrorMessages().get_USER_NOT_FOUND())){
			JLabel generic_response_msg = new JLabel(response_mpm);
			...
			reference.getNotification().info(response_mpm);
		}
