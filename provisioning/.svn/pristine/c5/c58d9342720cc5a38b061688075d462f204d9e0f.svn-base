...
public class ProvisioningResource implements BsoResourceInterface{
	...
	public void initialize() {
		...
		rdbtnIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				parametersList = util.actionSelected();
			}
		});
	...
	private void setExecuteButton(){
		btnExecute = new JButton(PROVISIONINGActions.PROVISIONING_ACTION_EXECUTE);
		...
		btnExecute.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(btnExecute.getActionCommand().equals(PROVISIONINGActions.PROVISIONING_ACTION_EXECUTE)){
