...
/**
 * 
 * @author Valerio Boschi and Daniela R. Auricchio
 *
 */
public class ActionAccountDetails implements SpecificActionGetResources{
	...
	public String get(String msisdn, String market, String ctype){
		...
		command.append(ALLRESOURCECommands.ACCOUNTDETAILS);
