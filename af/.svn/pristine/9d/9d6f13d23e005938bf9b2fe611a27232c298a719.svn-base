...
public class AccountFinder implements AccountFinderInterface{
	...
	private JLabel sdpHostNameLabel;
	
	private JComboBox sdpSelection;
	
	private AccountFinderResponseManagerInterface responseManager;
	private AccountFinderVerifyInterface verification;
	private AccountFinderUtilInterface util;
	private AccountFinderResponseGridManagerInterface responseGridManager;
	...
	private void setHostNameLabel(){
		sdpHostNameLabel = new JLabel("Hostname*");
		sdpHostNameLabel.setVisible(false);
		sdpHostNameLabel.setHorizontalAlignment(SwingConstants.RIGHT);
		command_fieldset.add(sdpHostNameLabel, commonGUI.setContraints(GridBagConstraints.VERTICAL, GridBagConstraints.WEST, 10, 5, 0, 5, 0, 3));
	}
	...
	private void setMsisdnText(){
		...
		command_fieldset.add(msisdnField, commonGUI.setContraints(GridBagConstraints.VERTICAL, GridBagConstraints.WEST, 5, 0, 0, 0, 1, 2));
		msisdnField.setEnabled(false);
		JComboBox msisdn_combo = msisdnCompleter.setupAutoComplete(msisdnField);
		msisdnField.setLayout(new BorderLayout());
		msisdnField.add(msisdn_combo, BorderLayout.SOUTH);
	}
	
	private void setHostNameCombo(){
		sdpSelection = new JComboBox(util.compileComboBox());
		sdpSelection.setVisible(false);
		sdpSelection.setPrototypeDisplayValue("***************");
		sdpSelection.setMaximumRowCount(5);
		command_fieldset.add(sdpSelection, commonGUI.setContraints(GridBagConstraints.VERTICAL, GridBagConstraints.WEST, 5, 0, 0, 0, 1, 3));
		sdpSelection.setEnabled(false);
	}
