 ...
 * 
 */
public class OptionManagmentInitialization implements OptionManagmentInitializationInterface{
	...
	public OptionManagmentInitialization(DAPBeanInterface components){
	...
	private void initializeInternalObjects(){
		xml_reader = new XmlReader();
		xml_reader.setComponents(components);
	}
