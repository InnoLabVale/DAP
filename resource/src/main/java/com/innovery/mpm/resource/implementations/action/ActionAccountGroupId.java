...
public class ActionAccountGroupId implements ActionResourceInterface{
	...
	public String update(CommonResourceInterface resourceBean){
		...
		command.append(AIRCommands.PARAMETER_ACCOUNTGROUPID).append(resourceBean.getAccountGroupId().getAgi());
