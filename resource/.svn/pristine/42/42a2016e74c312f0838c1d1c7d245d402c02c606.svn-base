...
public class ActionSIMExp implements ActionResourceInterface{
	...
	public String update(CommonResourceInterface resourceBean){
		...
		if(!resourceBean.getSim().getSimExpDate().equals("")){
			command.append(AIRCommands.PARAMETER_SIMEXP_ABS_EXPIRYDATE).append(resourceBean.getSim().getSimExpDate());
		}
		else if(!resourceBean.getSim().getSimExpDateAdj().equals("")){
			command.append(AIRCommands.PARAMETER_SIMEXP_REL_EXPIRYDATE).append(resourceBean.getSim().getSimExpDateAdj());
		}
