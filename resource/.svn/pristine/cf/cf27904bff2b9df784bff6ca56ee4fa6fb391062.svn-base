...
public class GuiDedicatedAccountPanel extends GuiResourcePanelInterface{
	...
	public GuiDedicatedAccountPanel(DAPBeanInterface components, JRadioButton rdbtnCreate, JRadioButton rdbtnDelete, JRadioButton rdbtnGet, JRadioButton rdbtnUpdate){
